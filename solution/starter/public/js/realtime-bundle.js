var CymbalFlixRealtime = (() => {
  ...
  // public/js/realtime-src.js
  var realtime_src_exports = {};
  __export(realtime_src_exports, {
    cleanup: () => cleanup,
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
  ...
  async function initializeFirebase(projectId, databaseId) {
    console.log("\u{1F525} Connecting to Firestore Enterprise...");
  ...
  function subscribeToStats(onStatsUpdate) {
    ...
    console.log("\u{1F4CA} Real-time stats active");
  ...
  async function toggleOffline() {
    ...
    if (isOfflineMode) {
      ...
      isOfflineMode = false;
      console.log("\u{1F310} Back online");
    } else {
  ...
  return __toCommonJS(realtime_src_exports);
})();
